...
int main() {
    ...
    report.dma3_madr = 0x00123450u;
    report.dma3_bcr = 0x00010003u;
    report.dma3_chcr = 0x11000000u;
    report.cd_current_lba = 37310u;
    report.cd_data_bytes = 0u;
    report.cd_request = 0x80u;
    report.cd_irq_pending = true;
    report.cd_deferred_response_count = 1u;
    ...
    CHECK(text.find("dma3_madr=0x00123450") != std::string::npos);
    CHECK(text.find("dma3_bcr=0x00010003") != std::string::npos);
    CHECK(text.find("dma3_chcr=0x11000000") != std::string::npos);
    CHECK(text.find("cd_current_lba=37310") != std::string::npos);
    CHECK(text.find("cd_data_bytes=0") != std::string::npos);
    CHECK(text.find("cd_request=128") != std::string::npos);
    CHECK(text.find("cd_irq_pending=1") != std::string::npos);
    CHECK(text.find("cd_deferred_response_count=1") != std::string::npos);
